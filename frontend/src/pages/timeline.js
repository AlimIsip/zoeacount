            ...
            <Body>
                ...
                <table className="border-collapse table-auto w-full text-xl text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th className="border border-slate-600 px-6 py-2 text-xs">Timestamp</th>
                    ...
                    {data.map((row) => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td className="border border-slate-600 px-6 py-4 text-xs"><img src={row.img_blob} width={150}/></td>
                            ...
                            <td className="border border-slate-600 px-6 py-4 text-xs">{row.timestamp}</td>
